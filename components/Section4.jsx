  ...
  return (
    ...
    <div className=" bg-slate-950 h-fit w-full flex flex-col items-center pb-28">
      <Fade fraction={0} duration={3000}>
          ...
          <div id="sec4comp" className="flex flex-col justify-center items-center xl:flex-row h-fit w-full xl:px-56 mt-10 ">
            
            <div
              id="component1"
              className="flex flex-col justify-center items-center xl:w-1/3"
            >
